...
var Estudante = /*#__PURE__*/_createClass(function Estudante(nome, nota) {
  _classCallCheck(this, Estudante);
  this.nome = nome;
  this.nota = nota;
});
;
function criarLista(tamanho) {
  ...
  for (var i = 1; i <= tamanho; i++) {
    ...
    var estudante = new Estudante("Aluno".concat(i), nota);
...
;
//
var listaEstudantes = criarLista(25);
var listaAcimaMedia = acimaMedia(listaEstudantes);
